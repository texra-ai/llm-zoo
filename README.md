...
| Code Execution | 20+ | `sonnet46`, `gpt41`, `gemini36f` |
...
| **OpenAI** | 41 | GPT-5.x reasoning, Fast mode tier, Cyber (Daybreak), deep research |
...
| **DashScope** | 4 | Qwen 3.8 Max, Qwen with 1M context |
