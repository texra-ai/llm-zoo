...
export const ANTHROPIC_MODELS: Record<string, ModelConfig> = {
  fable5: {
    ...
    copilotFullName: 'claude-fable-5',
  ...
  opus48T: {
    ...
    copilotFullName: 'claude-opus-4.8',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 128000,
    contextWindow: 1000000,
    inputPrice: 5.0,
  ...
  opus47T: {
    ...
    copilotFullName: 'claude-opus-4.7',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 128000,
    contextWindow: 1000000,
    inputPrice: 5.0,
  ...
  opus46T: {
    ...
    copilotFullName: 'claude-opus-4.6',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 128000,
    contextWindow: 1000000,
    inputPrice: 5.0,
  ...
  sonnet5T: {
    ...
    copilotFullName: 'claude-sonnet-5',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 128000,
    contextWindow: 1000000,
  ...
  opus45T: {
    ...
    copilotFullName: 'claude-opus-4.5',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 64000,
  ...
  sonnet45T: {
    ...
    copilotFullName: 'claude-sonnet-4.5',
    provider: ModelProvider.ANTHROPIC,
    maxOutputTokens: 64000,
    contextWindow: 200000,
    inputPrice: 3.0,
