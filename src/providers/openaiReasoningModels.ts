...
export const OPENAI_REASONING_MODELS: Record<string, ModelConfig> = {
  ...
  gpt56: {
    ...
    vscodeLMFullName: 'gpt-5.6-sol',
    copilotFullName: 'gpt-5.6-sol',
    provider: ModelProvider.OPENAI,
    maxOutputTokens: 128000,
    contextWindow: 1050000,
    inputPrice: 5.0,
  ...
  'gpt56--': {
    ...
    vscodeLMFullName: 'gpt-5.6-luna',
    copilotFullName: 'gpt-5.6-luna',
    provider: ModelProvider.OPENAI,
    maxOutputTokens: 128000,
    contextWindow: 1050000,
    inputPrice: 1.0,
