 ...
 * Includes Qwen3.8 Max, Qwen 3 Max, Plus, and Turbo variants.
 */
export const DASHSCOPE_MODELS: Record<string, ModelConfig> = {
  ...
  // multimodal (text/image/video), 1M-token context.
  qwen38max: {
    name: 'qwen38max',
    label: 'Qwen3.8 Max',
    ...
    // International (Singapore) pricing; Beijing/Frankfurt/Virginia/Tokyo run lower.
    inputPrice: 2.0,
    outputPrice: 6.0,
    capabilities: {
      ...
      // Implicit cached input $0.25 / 1M vs $2 / 1M input.
