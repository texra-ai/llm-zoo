...
export const XAI_MODELS: Record<string, ModelConfig> = {
  // Grok 4.5 (released 2026-07-08): xAI's flagship model, tuned for coding,
  // agentic work, and knowledge tasks. 500K context; max_completion_tokens
  // defaults to 128,000 per xAI's API reference.
  grok45: {
    name: 'grok45',
    label: 'Grok 4.5',
    fullName: 'grok-4.5',
    ...
    capabilities: {
      ...
      // Cached input $0.30 / 1M vs $2.00 / 1M input (sub-200K tier).
